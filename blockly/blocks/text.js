...
Blockly.Blocks['text_getSubstring'] = {
  ...
  updateAt_: function(n, isAt) {
    ...
    if (isAt) {
      this.appendValueInput('AT' + n).setCheck(Blockly.Types.NUMBER.getcheckList());
...
Blockly.Blocks['text_prompt_ext'] = {
  ...
  init: function() {
    var TYPES = [
      [Blockly.Msg['TEXT_PROMPT_TYPE_TEXT'], Blockly.Types.TEXT.getoutput()],
      [Blockly.Msg['TEXT_PROMPT_TYPE_NUMBER'], Blockly.Types.NUMBER.getoutput()]
    ];
    ...
    this.setTooltip(function() {
      return (thisBlock.getFieldValue('TYPE') == Blockly.Types.TEXT.getoutput()) ?
  ...
  updateType_: function(newOp) {
    this.outputConnection.setCheck(newOp == Blockly.Types.NUMBER.getoutput() ?
        Blockly.Types.NUMBER.getcheckList() : Blockly.Types.TEXT.getcheckList());
  },
  /**
  ...
  getBlockType: function() {
    return (this.getFieldValue('TYPE') == Blockly.Types.TEXT.getoutput()) ?
...
Blockly.Blocks['text_prompt'] = {
  ...
  getBlockType: function() {
    return (this.getFieldValue('TYPE') == Blockly.Types.NUMBER.getoutput()) ?
