...
Blockly.Msg.ARD_DIO_PLAYTRACK = "Speel track nummer ";
Blockly.Msg.ARD_DIO_SETLOUDNESS = "Diorama: zet volume op (0-10):";
Blockly.Msg.ARD_DIO_SOUND_TIP = "Verander volume van het Diorama bord";
...
Blockly.Msg.ARD_DIO_TRACK_TIP = "Als nummer 1, speel dan track opgeslagen op de SD kaart als 'track001.mp3'";
Blockly.Msg.ARD_DIO_TRACK_WARNING = "Track moet een getal tussen 1 en 100 zijn!";
...
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "Meet de duur van een puls op een geselecteerde pin, zolang het gebeurt binnen de opgegeven maximale duur (in microseconden).";
