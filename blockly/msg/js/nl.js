...
Blockly.Msg.ARD_DHT_READHEATINDEX_TIP = "Berekend de hitte index (gevoelstemperatuur) in graden Celcius van de DHT sensor";
...
Blockly.Msg.ARRAY_CREATE_WITH_CONTAINER_TITLE_ADD = "lijst";
Blockly.Msg.ARRAY_CREATE_WITH_CONTAINER_TOOLTIP = "Voeg toe, verwijder, of herorden secties om het lijst block te wijzigen.";
Blockly.Msg.ARRAY_CREATE_WITH_INPUT_WITH = "Maak een lijst met";
Blockly.Msg.ARRAY_CREATE_WITH_ITEM_TITLE = "item";
Blockly.Msg.ARRAY_CREATE_WITH_ITEM_TOOLTIP = "Voeg een item toe aan de lijst.";
Blockly.Msg.ARRAY_CREATE_WITH_TOOLTIP = "Maak een lijst met gegeven items";
Blockly.Msg.ARRAY_GETINDEX_AT = "neem element met index";
Blockly.Msg.ARRAY_GETINDEX_ITEM = "in Lijst variable";
Blockly.Msg.ARRAY_GETINDEX_TOOLTIP = "Verkrijg een element in de lijst op een bepaalde index";
