...
Blockly.Msg.ARD_BOARD_WARN = "This block requires as board %1, but another block is present that requires another Arduino board!";  // untranslated
...
Blockly.Msg.ARD_BUTTON_TIP = "Een drukknop die AAN of UIT kan zijn";  // untranslated
Blockly.Msg.ARD_COMPONENT_WARN1 = "A %1 configuration block with the same %1 name must be added to use this block!";  // untranslated
...
Blockly.Msg.ARD_LEDLEG = "LED light";  // untranslated
...
Blockly.Msg.ARD_LEDLEG_TIP = "A LED light which can be ON or OFF.";  // untranslated
...
Blockly.Msg.ARD_MD_180SERVO = "0~180 graden Servo";  // untranslated
Blockly.Msg.ARD_MD_360SERVO = "0~360 graden Servo";  // untranslated
...
Blockly.Msg.ARD_MD_AUDIO_PLAY_TIP = "Write the number (first, second, ... denoted by 1,2,...) of the sound fragment you want to play. On the SD card these must be present in the folder with name '1'!";  // untranslated
