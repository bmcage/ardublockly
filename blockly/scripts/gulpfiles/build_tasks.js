...
/**
 * This task builds the arduino generator:
...
function buildUncompressed() {
  const closurePath = '../closure-library/closure/goog';
...
--quiet`;
  ...
  //now do the ardublockly messages
