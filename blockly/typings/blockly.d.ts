...
declare module Blockly {
    ...
    class Block__Class implements Blockly.IASTNodeLocation  { 
            ...
            /** 
             * An optional method called for Arduino.
             * @type {?function()}
             */
            getArduinoLoopsInstance: { (): any /*missing*/ };
    
            /** 
             * An optional method called for Arduino.
             * @type {?function()}
             */
            getArduinoDeclareUpfrontInstance: { (): any /*missing*/ };
    
            /**
               * Optional method that gets the variable type required.
               * @param {!string} varName Name of the variable selected in this block to
               *     check.
               * @return {string} String to indicate the variable type.
               */
            getVarType(varName: string): string;
    
            /**
             * Searches through a list of variables with type to assign the type of the
             * arguments.
             * @this Blockly.Block
             * @param {Object} existingVars Associative array variable already
             *     defined, names as key, type as value.
             */
            setArgsType(existingVars: Object): void;
...
declare module Blockly {
    ...
    class FieldHSVColour extends FieldHSVColour__Class { }
    /** Fake class which should be extended to avoid inheriting static properties */
    class FieldHSVColour__Class extends Blockly.Field__Class  { 
...
declare module Blockly {
    ...
    class FieldInstance extends FieldInstance__Class { }
    /** Fake class which should be extended to avoid inheriting static properties */
    class FieldInstance__Class extends Blockly.FieldDropdown__Class  { 
             ...
             * @constructor
             */
            constructor(instanceType: string, instanceName: string, uniqueName: boolean, opt_lockNew?: boolean, opt_lockRename?: boolean, opt_editDropdownData?: any /* jsdoc error */, opt_validator?: Function);
             ...
             */
            dropdownChange(text: string): any /*null*/|any /*undefined*/|string;
    } 
...
declare module Blockly.Instances {
     ...
     * @return {!Array.<string>} Array of instance names.
     */
    function allInstancesOf(instanceType: any /* jsdoc error */, workspace: any /* jsdoc error */): void;

    /** Returns all instances of all types. */
    function allInstances(workspace: any /* jsdoc error */): void;

    /** Returns the first Instance name of a given type. */
    function getAnyInstanceOf(instanceType: any /* jsdoc error */, workspace: any /* jsdoc error */): void;

    /** Indicates if the given instance is present in the workspace. */
    function isInstancePresent(instanceName: any /* jsdoc error */, instanceType: any /* jsdoc error */, block: any /* jsdoc error */): void;
     ...
     */
    function renameInstance(oldName: string, newName: string, instanceType: any /* jsdoc error */, workspace: Blockly.Workspace): void;
     ...
     */
    function convertToUniqueName(instanceName: string, workspace: Blockly.Workspace|Blockly.Block): string;

    /** */
    function convertToUniqueNameBlock(instanceName: any /* jsdoc error */, block: any /* jsdoc error */): void;

    /** */
    function appendToName_(instanceName: any /* jsdoc error */, nameList: any /* jsdoc error */): void;
}
...
declare module Blockly {
    ...
    class StaticTyping extends StaticTyping__Class { }
    /** Fake class which should be extended to avoid inheriting static properties */
    class StaticTyping__Class  { 
             ...
             */
            collectVarsWithTypes(workspace: Blockly.Workspace): Object;
             ...
             */
            assignTypeToVars(block: Blockly.Block, varName: string, varType: Blockly.Type): void;
             ...
             */
            setBlockTypeWarning(block: Blockly.Block, blockType: Blockly.Type, varName: string): void;
...
declare module Blockly.StaticTyping {
     ...
     *     blocks.
     */
    function getAllStatementsOrdered(workspace: Blockly.Workspace): Blockly.Block[];
    ...
    /**
      ...
      */
    function getBlockVars(block: Blockly.Block): string[][];
}
...
declare module Blockly {
    ...
    class Type extends Type__Class { }
    /** Fake class which should be extended to avoid inheriting static properties */
    class Type__Class  { 
             ...
             */
            addCompatibleType(compatibleType: Blockly.Type): void;
             ...
             *     compatibility list.
             */
            addCompatibleTypes(compatibleTypeArray: Blockly.Type[]): void;
    } 
    
}


declare module Blockly.Types {

    /** Single character. */
    var CHARACTER: any /*missing*/;

    /** Text string. */
    var TEXT: any /*missing*/;

    /** Boolean. */
    var BOOLEAN: any /*missing*/;

    /** Short integer number. */
    var SHORT_NUMBER: any /*missing*/;

    /** Unsigned integer number. */
    var UNSIGNED_NUMBER: any /*missing*/;

    /** Integer number. */
    var NUMBER: any /*missing*/;

    /** Large integer number. */
    var LARGE_NUMBER: any /*missing*/;

    /** Decimal/floating point number. */
    var DECIMAL: any /*missing*/;

    /** Array/List of items. */
    var ARRAY: any /*missing*/;

    /** Null indicate there is no type. */
    var NULL: any /*missing*/;

    /** Type not defined, or not yet defined. */
    var UNDEF: any /*missing*/;

    /** Set when no child block (meant to define the variable type) is connected. */
    var CHILD_BLOCK_MISSING: any /*missing*/;
     ...
     *     compatible with.
     */
    function addType(typeId_: string, typeMsgName_: string, compatibleTypes_: Blockly.Type[]): void;
     ...
     */
    function getValidTypeArray(): string[][];
     ...
     */
    function getChildBlockType(block: Blockly.Block): Blockly.Type;
     ...
     */
    function identifyNumber(numberString: string): Blockly.Type;
}
...
declare module Blockly.Msg {
     ...
     */
    var B4A_NO_CHROME: any /*missing*/;

    /**
     * Ardublockly Types
     */
    var ARD_TYPE_CHAR: any /*missing*/;

    /**
     * Ardublockly instances
     */
    var NEW_INSTANCE: any /*missing*/;

    /**
     * Blockly4Arduino extras
     */
    var ARD_TYPE_CHILDBLOCKMISSING: any /*missing*/;
}
